...
def test_update_ingredient_service(client, create_ingredient, ingredient_url):
...
def test_get_ingredient_by_id_service(client, create_ingredient, ingredient_url):
    current_ingredient = create_ingredient.json
...
def test_get_ingredients_service(client, create_ingredients, ingredient_url):
