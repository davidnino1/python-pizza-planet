...
def test_create_order_service_returns_a_200_response(create_order):
...
def test_get_order_by_id_service_returns_a_200_response(client, create_order, order_url):
    current_order = create_order.json
...
def test_get_orders_service_returns_a_200_response(client, create_orders, order_url):
